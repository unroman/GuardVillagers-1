...
public class GuardVillagerScreen extends HandledScreen<GuardVillagerScreenHandler> {
    ...
    protected void init() {
        ...
        if (/*TODO GuardVillagersConfig.get().setGuardPatrolHotv && */player.hasStatusEffect(StatusEffects.HERO_OF_THE_VILLAGE) || true /*TODO || !GuardVillagersConfig.get().setGuardPatrolHotv*/) {
