...
public class GuardRenderer extends BipedEntityRenderer<GuardEntity, BipedEntityModel<GuardEntity>> {
    ...
    public GuardRenderer(EntityRendererFactory.Context context) {
        ...
        if (false /*TODO GuardVillagersConfig.get().useSteveModel*/)
            this.model = steve;
        else
            this.model = normal;
        this.addFeature(new ArmorFeatureRenderer<>(this, true /*!GuardVillagersConfig.get().useSteveModel*/ ?
        new GuardArmorModel(context.getPart(GuardVillagersClient.GUARD_ARMOR_INNER)) : new BipedEntityModel<>(context.getPart(EntityModelLayers.PLAYER_INNER_ARMOR)),
                true /*TODO !GuardVillagersConfig.get().useSteveModel*/ ?
    ...
    public Identifier getTexture(GuardEntity entity) {
        return true/*TODO !GuardVillagersConfig.get().useSteveModel*/
